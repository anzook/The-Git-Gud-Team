document.addEventListener("DOMContentLoaded", function(event) {
  ...
  $("#search-btn").on("click", function(event) {
    ...
    if (document.getElementById("list-checkbox-2").checked) {
      //front end
      queryParamsadunza.what += "html css ";
    }

    if (document.getElementById("list-checkbox-3").checked) {
      //back end
      queryParamsadunza.what += "javascript ";
    }

    if (document.getElementById("list-checkbox-4").checked) {
      // UI / UX
      queryParamsadunza.what += "user experience interaction ";
    }

    if (document.getElementById("list-checkbox-5").checked) {
      //Digital Marketing
    ...
    $.ajax({
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        newJob.attr(
          "style",
          "margin: 20px; padding: 15px; background: whitesmoke;"
        );
